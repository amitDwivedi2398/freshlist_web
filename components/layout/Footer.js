                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-12">
                      <div
                        style={{
                          background: `url(${value?.banner_img[0]})`,
                        }}
                        className="position-relative newsletter-inner"
                      >
                        {/* <img src={firsts[0].banner_img} /> */}
                        <div className="newsletter-content">
                          <h2 className="mb-20">{value?.banner_title}</h2>
                          {/* <p className="mb-45">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-4 col-lg-6 col-md-6">
              <ul className="st-1">
                <li>
                  <a href="/">
                    <img src="/assets/imgs/theme/homa.png" alt="" width={30} />
                    <p>Home</p>
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/shop-filter">
                    <img src="/assets/imgs/theme/stor.png" alt="" width={30} />
                    <p>Store</p>
                  </a>
                </li>
                <li>
                  <a href="/shop-cart">
                    <img src="/assets/imgs/theme/cart.png" alt="" width={30} />
                    <p>Cart</p>
                  </a>
                </li>
                <li>
                  <a href="/page-account">
                    <img src="/assets/imgs/theme/custo.png" alt="" width={30} />
                    <p>Profile</p>
                  </a>
                </li>
              </ul>
              <p className="font-sm mb-0">
                &copy; 2022, <strong className="text-brand"></strong>
                All rights reserved
              </p>
            </div>
            <div className="col-xl-5 col-lg-6 text-center d-none d-xl-block">
